...
function telefon()
{
    ...
    tel.innerHTML = "+48 000-000-000"
}
function email()
{
    e=document.getElementById("email");
    e.innerHTML = "Jan.Kowalski@example.com";
}
function adres()
{
    e=document.getElementById("adres");
    e.innerHTML = "Marchewkowa 5, Żeromskiego 4";
}
function hover(x)
{
    ...
    if (czydark==false)
    {
        x.style.backgroundColor = "rgb(209, 205, 205)";
    }
    else if (czydark == true)
    {
        x.style.backgroundColor = "rgb(94, 94, 94)" 
    }
}
function offhover(x)
{
    if(czydark==false)
    {  
        x.style.backgroundColor = "rgb(221, 218, 218)";
    }
    else if(czydark == true)
    {
        x.style.backgroundColor = "rgb(114, 114 ,114)";
    }
}
function hover2(x)
{
...
function linkpelar()
{
    window.location.href = "index.html#pelargonie"
}